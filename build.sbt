...
val `scala3-compiler-predef` = Build.`scala3-compiler-predef`
val `scala3-compiler-core`   = Build.`scala3-compiler-core`
val `scala3-compiler-phases` = Build.`scala3-compiler-phases`
val `scala3-compiler-interactivemode` = Build.`scala3-compiler-interactivemode`
